...
pierre_editor = Editor.create(user_id: pierre.id, email: pierre.email, phone_number: "+33 6 42 12 21 81", name: "Pierre Coppermann", address: "Paris")
p "Pierre created"
...
margot_editor = Editor.create(user_id: margot.id, email: margot.email, phone_number: "+33 6 79 17 84 90", name: "Margot Wilwertz", address: "Paris")
p "Margot created"

p "creating Lea"
lea = User.create(email: "lea@gmail.com", password: "123456", first_name: "Lea", last_name: "Wehbe", username:"lea", subscription: "premium")
lea_editor = Editor.create(user_id: lea.id, email: lea.email, phone_number: "+33 6 11 65 40 79", name: "Lea Wehbe", address: "Paris")
...
simon_editor = Editor.create(user_id: simon.id, email: simon.email, phone_number: "+33 7 81 75 83 29", name: "Simon Bonnaventure", address: "Paris")
...
gaia_editor = Editor.create(user_id: gaia.id, email: gaia.email, phone_number: "+39 340 308 0681", name: "Gaia Gallarini", address: "Paris")
...
rachel_editor = Editor.create(user_id: rachel.id, email: rachel.email, phone_number: "+33 7 50 80 83 31", name: "Rachel Lamy", address: "Paris")
